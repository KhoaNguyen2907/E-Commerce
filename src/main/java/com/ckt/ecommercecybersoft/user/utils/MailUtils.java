...
public class MailUtils {
    ...
    public static final String EMAIL_VERIFICATION_URL = "/api/v1/users/email-verifications?token=";
     ...
     */
    public static final String PASSWORD_RESET_URL = "/api/v1/users/verify-password-reset-token?token=";
